...
export default class BasicFlatList extends Component {
  ...
  componentWillMount() {
    firebase
      ...
      .ref('test/')
      .on('value', snapshot => {
        console.log(snapshot.child('FlatListData').val());
        // for (i in snapshot.child('FlatListData').val().length) {
        //   user.push(snapshot.child('FlatListData').val()[i]);
        //   console.log(i);
        //}
        this.setState({ user: snapshot.child('FlatListData').val() });
        //user = snapshot.child('FlatListData').val();
